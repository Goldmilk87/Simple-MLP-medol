...
x1 = np.random.randint(0, 20, size=10000)
x2 = np.random.randint(0, 20, size=10000)
x3 = np.random.randint(0, 20, size=10000)
...
x1 = np.random.randint(0, 20, size=100)
x2 = np.random.randint(0, 20, size=100)
x3 = np.random.randint(0, 20, size=100)
...
print(predictor(df, w1, b1, w2, b2))
print(mse(df, w1, b1, w2, b2))

print(predictor(test_df, w1, b1, w2, b2))
print(mse(test_df, w1, b1, w2, b2))
print(w1, b1, w2, b2)
